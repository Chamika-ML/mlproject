...
class PredictPipeline:
    ...
    def predict(self,features):
        """ This function is uded to get predcitons from our ml model by inputting user enterd data"""
        try:
...
class CustomData:
    ...
    def get_data_as_data_frame(self):
        """" This function is used to convert the user given features to a pandas data frame"""
        try:
